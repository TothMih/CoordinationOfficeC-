...
namespace CoordinatorOffice.ApiClient.Handlers
{
    public class TokenAuthHandler2 : DelegatingHandler
    {
        ...
        public TokenAuthHandler2(string path, string accessToken, string refreshToken, string? baseUrl = null)
        {
            _path = path;
